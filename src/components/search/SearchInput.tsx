      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="absolute mt-2 left-0 right-0 top-full rounded-xl border border-primary-700 bg-white shadow-xl px-4 pt-3 pb-3 max-h-[55vh] overflow-auto z-50 origin-top"
          >
            ...
            {error && (
              <div className="text-caption text-state-red">{error}</div>
            )}
